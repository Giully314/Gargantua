/*
* gargantua/render/render_texture.cpp
*/
...
module gargantua.render.texture;
...
namespace gargantua::render
{
	...
	auto Texture::Load(const std::string_view filename) -> void
	{
	...
	auto Texture::Empty(const u32 width, const u32 height) -> void
	{
		info.width = width;
		info.height = height;
		info.data_format = GL_RGBA;
	...
	auto Texture::Fill(const u32 width, const u32 height, const void* data) -> void
	{
