/*
* gargantua/generator/gen_coroutinegenerator.ixx
* 
...
export module gargantua.gen.coroutine_generator;
...
export namespace gargantua::gen
{
	template <typename T>
	concept CGeneratorType = std::default_initializable<T> && std::movable<T>;

	template <CGeneratorType T>
	class Generator;
