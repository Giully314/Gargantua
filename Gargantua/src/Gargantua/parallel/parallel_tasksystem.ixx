/*
* gargantua/parallel/parallel_tasksystem.ixx
* 
* PURPOSE: provide a thread pool.
* 
* CLASSES:
*	TaskSystem: implementation of a thread pool based scheduler for tasks.
* 
* DESCRIPTION:
* 
* TODO:
...
{
	export class TaskSystem : NonCopyable, NonMovable
	{
	public:
		static
