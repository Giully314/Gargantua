...
{
	export
	class ComponentStorageHandler : private NonCopyable
	{
	public:
	...
	public:
		...
		*/
		...
		auto Emplace(const entity_t e, Args&& ...args) -> T&
		{
		...
		*/
		[[nodiscard]]
		auto Has(const entity_t e) const noexcept -> bool
		{
		...
		*/
		[[nodiscard]]
		auto operator[](const entity_t e) -> T&
		{
		...
		[[nodiscard]]
		auto begin() -> ds::SparseSet<entity_t>::iterator
		{
		...
		[[nodiscard]]
		auto end() -> ds::SparseSet<entity_t>::iterator
		{
		...
		[[nodiscard]]
		auto cbegin() -> ds::SparseSet<entity_t>::const_iterator
		{
			return entities_registered.begin();
		}
		...
		[[nodiscard]]
		auto cend() -> ds::SparseSet<entity_t>::const_iterator
		{
			return entities_registered.end();
		}
